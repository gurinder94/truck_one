...
ProductView productViewFromJson(String str) =>
    ProductView.fromJson(json.decode(str));
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        wishListData: List<WishListDatum>.from(
            json["wishListData"].map((x) => WishListDatum.fromJson(x))),
        iswishList: json["iswishList"],
        productNumber: json["productNumber"],
        oem: json["OEM"],
        suitableForModels:
            List<dynamic>.from(json["suitableForModels"].map((x) => x)),
        ...
        images: List<Images>.from(json["images"] == null
            ? []
  ...
  Map<String, dynamic> toJson() => {
        ...
        "OEM": oem,
        "suitableForModels":
            List<dynamic>.from(suitableForModels!.map((x) => x)),
        "brandName": brandName,
