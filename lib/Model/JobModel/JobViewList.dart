...
JobListDetailModel jobListDetailModelFromJson(String str) => JobListDetailModel.fromJson(json.decode(str));

String jobListDetailModelToJson(JobListDetailModel data) => json.encode(data.toJson());
...
class JobListDetailModel {
  ...
  factory JobListDetailModel.fromJson(Map<String, dynamic> json) => JobListDetailModel(
    code: json["code"],
    message: json["message"],
    data: json["data"]==null?[]:List<JobDetailModel>.from(json["data"].map((x) => JobDetailModel.fromJson(x))),
  );
...
class JobDetailModel extends ChangeNotifier{
  ...
  factory JobDetailModel.fromJson(Map<String, dynamic> json) => JobDetailModel(
    ...
    qualificationData: List<QualificationDatum>.from(json["qualificationData"].map((x) => QualificationDatum.fromJson(x))),
    ...
    salaryRang: List<SalaryRang>.from(json["salaryRang"].map((x) => SalaryRang.fromJson(x))),
    title: json["title"],
    ...
    companyWebsite: json["companyWebsite"]==null?'N/A':json["companyWebsite"],
  ...
  Map<String, dynamic> toJson() => {
    ...
    "isSaved": isSaved,
    "vacancy": vacancy,
    "qualificationData": List<dynamic>.from(qualificationData!.map((x) => x.toJson())),
...
class QualificationDatum {
  ...
  factory QualificationDatum.fromJson(Map<String, dynamic> json) => QualificationDatum(
    id: json["_id"],
...
class WalkInDetail {
  ...
  factory WalkInDetail.fromJson(Map<String, dynamic> json) => WalkInDetail(
    ...
    timing: json["timing"],
    contactPerson: json["contactPerson"]==null?'N/A':json["contactPerson"],
