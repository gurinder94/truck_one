                    ...
                    leading: Container(
                        ...
                        child: Checkbox(
                            value: productListProvider
                                .brandListModel.data![index].check,
                            onChanged: (val) {
                              productListProvider
                                  .brandListModel.data![index].check = val!;
                              setState(() {
                                if (productListProvider
                                        .brandListModel.data![index].check ==
                                    true)
                                  productListProvider.valueBrand.add(
                                      productListProvider
                                          .brandListModel.data![index].id);
                                else
                                  productListProvider.valueBrand.remove(
                                      productListProvider
                                          .brandListModel.data![index].id);
                                print(productListProvider.valueBrand);
                              });
                            })),
                    title: Text(productListProvider
                        .brandListModel.data![index].brand
                        .toString()),
                  );
                }),
          )
