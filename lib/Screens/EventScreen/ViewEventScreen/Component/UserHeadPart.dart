    ...
    return Container(
      ...
      child: Stack(children: [
        ...
        Container(
          width: double.infinity,
          height: 250,
          child: CustomImage(image:  SERVER_URL + '/uploads/event/image/' +_eventViewProvider.eventModel!.bannerImage.toString() , width: double.infinity, boxFit:BoxFit.cover, height: 250)
        ),
        Positioned(
          left: 20,
          bottom: 10,
          child:CustomImageProfile(image:  _eventViewProvider.eventModel!.brandLogo==null?''
            :Event_logo_Url + _eventViewProvider.eventModel!.brandLogo.toString() , width: 80, boxFit:BoxFit.cover,  height: 80,),
        ),
      ]),
    );
  }
