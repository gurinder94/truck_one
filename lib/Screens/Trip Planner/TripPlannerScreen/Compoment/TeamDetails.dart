...
class TeamDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      child: _listProvider.tripViewDetails!.data!.anotherDriverData==null?Column(
        children: [
          Container(
            ...
            child: Center(
              child: Text(
                AppLocalizations.instance.text('Another Details'),
        ...
        children: [
          ...
          TripDeatils(
              "Name",
              _listProvider.tripViewDetails!.data!.anotherDriverData!.personName.toString()
          ),
          Divider(
          ...
          TripDeatils(
              "Email",
              _listProvider.tripViewDetails!.data!.anotherDriverData!.email.toString(),
                  ),
          Divider(
            color: Colors.black38,
            height: 2,
          ...
          TripDeatils(
              "Phone Number",
              _listProvider.tripViewDetails!.data!.anotherDriverData!.mobileNumber.toString()
                  ),
          Divider(
            color: Colors.black38,
            height: 2,
