...
class SharePostDisplayPage extends StatefulWidget {
  PostItem provider;
   SharePostDisplayPage( this.provider);
      ...
      body: BackdropFilter(
          ...
          child: Stack(
            children: [
                ...
                children: [
                  Expanded(
                    child: PageView.builder(
                      itemCount: widget.provider.orignalPostData!.media!.length,
                      onPageChanged: (val) {
                        pagePos = val;
                        setState(() {});
                      },
                      ...
                      itemBuilder: (BuildContext context, int itemIndex) {
                        Media _media =widget.provider.orignalPostData!.media![itemIndex];
              ...
              Positioned(
                  bottom: 100,
                  child: DescriptionWhite(description: widget.provider.orignalPostData!.caption!)),
            ],
          )),
    );
  }
