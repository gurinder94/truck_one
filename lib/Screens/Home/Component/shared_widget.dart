            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    CustomImageProfile(
                        image: item.orignalPostData == null
                            ? IMG_URL + item.userData!.image.toString()
                            : IMG_URL +
                                item.orignalPostData!.userData!.image
                                    .toString(),
                        width: 50,
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            capitalize(
                              item.orignalPostData!.userData!.personName
                                  .toString(),
                            ),
                            style: TextStyle(
                ...
                item.orignalPostData!.media!.length == 0
                    ? SizedBox()
                    : ShareImageVideoComponent(
                        item.orignalPostData!.media!, item)
              ],
            ),
