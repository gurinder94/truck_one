...
//   PaymentSucessScreen(this.provider,this.clientSecret, this.totalPrice, this.name , {Key? key}) : super(key: key);
//
//   @override
...
//                   itemCount: provider.subscriptionPlanModel!.data!.length,
...
//                                   child: Text(
//                                     provider.subscriptionPlanModel!.data![index].title.toString(),
//                                     style: TextStyle(
...
//                             commonDisplayText(
//                                 "Plan Type",
//                                 provider.subscriptionPlanModel!.data![index]
//                                     .planName
//                                     .toString()
//                                     .toString()),
//                             Divider(),
...
//                                 provider.subscriptionPlanModel!.data![index].validity.toString()),
//                             Divider(),
//                           ],
//                         ),
