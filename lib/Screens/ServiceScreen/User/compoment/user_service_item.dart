...
class UserServiceItem extends StatelessWidget {
  ...
  UserServiceItem(this.serviceProvider, this.index, this.serviceList);
          ...
          LayoutBuilder(
            builder: (BuildContext context, BoxConstraints constraints) {
              if (constraints.maxWidth > 600) {
                return eventImage(
                    300, serviceList[index].serviceImage.toString());
              } else {
                return eventImage(
                    200, serviceList[index].serviceImage.toString());
              }
            },
          ),
          Padding(
              ...
              child: Column(
                  ...
                  children: [
                    Text(
                      capitalize(serviceList[index].serviceName.toString()),
                      style: TextStyle(
                        color: Colors.black,
                        fontSize: 18,
                    ...
                    Text(
                     AppLocalizations.instance.text('Service cost')+
                          ...
                          ' ' +
                          serviceList[index].serviceCost.toString(),
                      style: TextStyle(
                    ...
                    Text(
                      AppLocalizations.instance.text('Location')+
                          ...
                          ' ' +
                          serviceList[index].address.toString(),
  ...
  eventImage(double hei, String bannerImage) {
    return ClipRRect(
      ...
      child: Image.network(
        Base_Url_Image_Service + serviceList[index].serviceImage.toString(),
        height: hei,
        width: double.infinity,
        fit: BoxFit.cover,
