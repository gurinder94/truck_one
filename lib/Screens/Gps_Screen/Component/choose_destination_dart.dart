...
class ChooseDestination extends StatefulWidget {
  ...
  ChooseDestination(this.chooseDestination,this.addTripProvider );
        ...
        child: Column(children: [
          ...
          InputShape(
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                prefixIcon: GestureDetector(child: Icon(Icons.arrow_back),
                onTap: ()
                  {
                  ...
                  suffixIcon:IconButton(onPressed: ()
                  {
                    ...
                    widget.chooseDestination.text= "";
                    widget.addTripProvider.setvalueDestinationTextEditer("");
          ...
          Selector<ChooseSourceProvider, dynamic>(
              ...
              builder: (context, paginationLoading, child) {
                return paginationLoading==""?DestinationTripHistry(widget.addTripProvider):
